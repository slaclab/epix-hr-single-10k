...
set_property -dict {PACKAGE_PIN R23 IOSTANDARD LVDS} [get_ports {asicDataP[12]}]
set_property -dict {PACKAGE_PIN P23 IOSTANDARD LVDS} [get_ports {asicDataN[12]}]
set_property -dict {PACKAGE_PIN P20 IOSTANDARD LVDS} [get_ports {asicDataP[13]}]
set_property -dict {PACKAGE_PIN P21 IOSTANDARD LVDS} [get_ports {asicDataN[13]}]
set_property -dict {PACKAGE_PIN M20 IOSTANDARD LVDS} [get_ports {asicDataP[14]}]
set_property -dict {PACKAGE_PIN M21 IOSTANDARD LVDS} [get_ports {asicDataN[14]}]
set_property -dict {PACKAGE_PIN P28 IOSTANDARD LVDS} [get_ports {asicDataP[15]}]
set_property -dict {PACKAGE_PIN N28 IOSTANDARD LVDS} [get_ports {asicDataN[15]}]
set_property -dict {PACKAGE_PIN P25 IOSTANDARD LVDS} [get_ports {asicDataP[16]}]
set_property -dict {PACKAGE_PIN P26 IOSTANDARD LVDS} [get_ports {asicDataN[16]}]
set_property -dict {PACKAGE_PIN M24 IOSTANDARD LVDS} [get_ports {asicDataP[17]}]
set_property -dict {PACKAGE_PIN M25 IOSTANDARD LVDS} [get_ports {asicDataN[17]}]
