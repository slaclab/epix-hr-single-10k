...
cryoAsicBoard.EpixHRGen1Cryo.enable.get()

if cryoAsicBoard.EpixHRGen1Cryo.DeserRegisters.enable.get()==False :
    cryoAsicBoard.EpixHRGen1Cryo.DeserRegisters.enable.set(True)

for delay in range(0,31):
    cryoAsicBoard.EpixHRGen1Cryo.DeserRegisters.DelayEn0.set(True)
    cryoAsicBoard.EpixHRGen1Cryo.DeserRegisters.SerDesDelay0.set(delay)
    print("current delay: " + str(cryoAsicBoard.EpixHRGen1Cryo.DeserRegisters.Delay0.get())) 
    cryoAsicBoard.EpixHRGen1Cryo.DeserRegisters.Resync.set(True)
    cryoAsicBoard.EpixHRGen1Cryo.DeserRegisters.Resync.set(False)

    time.sleep(1.0 / float(10))

    print("locked : " + str(cryoAsicBoard.EpixHRGen1Cryo.DeserRegisters.Locked0.get()))
