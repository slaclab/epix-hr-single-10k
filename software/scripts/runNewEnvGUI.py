...
import argparse
import pyrogue.pydm
import ePixLiveDisplay.ePixGUI
import ePixLiveDisplay.ePixGUIEnvMonitoring
import ePixLiveDisplay.ePixGUIPseudoScope
...
if args.cmd == 'image':
    ePixLiveDisplay.ePixGUI.runEpixDisplay(dataReceiver=args.dataReceiver, serverList=args.serverList)
elif args.cmd == 'monitor':
    ePixLiveDisplay.ePixGUIEnvMonitoring.runEpixDisplay(dataReceiver=args.dataReceiver, serverList=args.serverList)
elif args.cmd == 'pseudoscope':
    ePixLiveDisplay.ePixGUIPseudoScope.runEpixDisplay(dataReceiver=args.dataReceiver, serverList=args.serverList)
